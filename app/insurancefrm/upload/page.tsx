...
const InsuranceCardUpload: React.FC = () => {
    ...
    const validateForm = (): boolean => {
        ...
        } else if (!/^(0[1-9]|1[0-2])\/(0[1-9]|[12]\d|3[01])\/\d{4}$/.test(dob)) {
    ...
    // Format DOB input to enforce MM/DD/YYYY pattern
    const handleDobChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
        ...
        if (value.length === 2 && !value.includes('/') && dob.length < 2) {
            value += '/';
        } else if (value.length === 5 && value.indexOf('/', 3) === -1 && dob.length < 5) {
            value += '/';
        }
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit}>
                                <div className="mb-4">
                                    ...
                                    />
                                    {errors.email ? (
                                        <p className="text-red-500 text-sm mt-1" id="email-error">{errors.email}</p>
                                    ) : (
                                        <p className="text-gray-500 text-sm mt-1" id="email-hint">We'll send you updates about your insurance verification</p>
                                    )}
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    />
                                    {errors.dob ? (
                                        <p className="text-red-500 text-sm mt-1" id="dob-error">{errors.dob}</p>
                                    ) : (
                                        <p className="text-gray-500 text-sm mt-1" id="dob-hint">Format: MM/DD/YYYY</p>
                                    )}
                                </div>
